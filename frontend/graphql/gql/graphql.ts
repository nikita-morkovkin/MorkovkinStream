...
export type FindChannelByUsernameQuery = { __typename?: 'Query', findChannelByUsername: { __typename?: 'UserModel', id: string, username: string, bio?: string | null, avatar?: string | null, isVerified: boolean, displayName: string } };
